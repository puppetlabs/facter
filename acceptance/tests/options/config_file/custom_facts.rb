test_name "custom-dir and no-custom-facts config fields allow control of custom fact lookup"
#
...
EOM
  ...
  step "setting custom-dir in config file should specify location to look for custom facts"
  ...
  step "setting no-custom-facts to true should prevent custom fact lookup"
