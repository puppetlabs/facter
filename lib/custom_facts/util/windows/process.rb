      ...
      module Process
        ...
        def open_process_token(handle, desired_access)
          ...
          begin
            ...
            LegacyFacter::Util::Windows::FFI::WIN32.CloseHandle(token_handle) if token_handle
          end
        ...
        def elevated_security?
          ...
          begin
            ...
            elevated
          rescue LegacyFacter::Util::Windows::Error => e
            raise e if e.code != ERROR_NO_SUCH_PRIVILEGE
          ensure
            LegacyFacter::Util::Windows::FFI::WIN32.CloseHandle(handle) if handle
          end
        end
