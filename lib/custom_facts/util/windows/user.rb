    ...
    module Windows
      module User
        ...
        def check_token_membership
          ...
          FFI::MemoryPointer.new(:byte, SECURITY_MAX_SID_SIZE) do |sid_pointer|
            FFI::MemoryPointer.new(:dword, 1) do |size_pointer|
              ...
              if CreateWellKnownSid(:WinBuiltinAdministratorsSid, FFI::Pointer::NULL, sid_pointer, size_pointer) ==
                 LegacyFacter::Util::Windows::FFI::WIN32_FALSE

                raise LegacyFacter::Util::Windows::Error, 'Failed to create administrators SID'
              end
            end

            raise 'Invalid SID' if IsValidSid(sid_pointer) == LegacyFacter::Util::Windows::FFI::WIN32_FALSE

            FFI::MemoryPointer.new(:win32_bool, 1) do |ismember_pointer|
              if CheckTokenMembership(LegacyFacter::Util::Windows::FFI::NULL_HANDLE, sid_pointer, ismember_pointer) ==
                 LegacyFacter::Util::Windows::FFI::WIN32_FALSE

                raise LegacyFacter::Util::Windows::Error, 'Failed to check membership'
              end
        ...
        attach_function :CheckTokenMembership,
                        %i[handle pointer pbool], :win32_bool
