...
module Facter
  ...
  # Return whether debugging output is turned on
  def self.debugging?
    @@debug != 0
  end
  ...
  # Return whether timing output is turned on
  #
  # @api private
  def self.timing?
    @@timing != 0
  ...
  # Adds a resolution mechanism for a named fact. This does not
  # distinguish between adding a new fact and adding a new way to
  # resolve a fact.
  #
  # @overload add(name, options = {}, { ... })
  # @param name [String] the fact name
  # @param options [Hash] optional parameters for the fact
  ...
  # changed on disk needs to be reloaded
  #
  # @return [void]
  #
  # @api public
