...
module Facter
  class FactManager
    ...
    def resolve_facts(user_query = [])
      ...
      cache_writer = Facter::Cache::CacheWriter.new

      cache_augmenter.augment_with_cache_group(searched_facts)
      searched_facts, cached_facts = cache_reader.read_from_cache(searched_facts)
      ...
      cache_writer.cache_facts(resolved_facts)
