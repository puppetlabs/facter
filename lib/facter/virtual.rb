...
Facter.add("virtual") do
  ...
  setcode do
    ...
    result = "physical"
    # use SPHardwareDataType for VMware and VirtualBox, since it is the most reliable source.
    ...
    # Parallels passes through almost all of the host's hardware info to the virtual machine, so use a different field.
