#ifndef LIB_INC_LOGGING_LOGGING_HPP_H_
#define LIB_INC_LOGGING_LOGGING_HPP_H_
...
#define LOG_DECLARE_NAMESPACE(ns) static log4cxx::LoggerPtr g_logger = log4cxx::Logger::getLogger("puppetlabs.cfacter." ns);
#define LOG_MESSAGE(level, format, ...) \
    do { \
        cfacter::logging::log(g_logger, level, format, ##__VA_ARGS__); \
    } while(0)
#define LOG_DEBUG(format, ...) LOG_MESSAGE(cfacter::logging::log_level::debug, format, ##__VA_ARGS__)
#define LOG_INFO(format, ...) LOG_MESSAGE(cfacter::logging::log_level::info, format, ##__VA_ARGS__)
#define LOG_WARNING(format, ...) LOG_MESSAGE(cfacter::logging::log_level::warning, format, ##__VA_ARGS__)
#define LOG_ERROR(format, ...) LOG_MESSAGE(cfacter::logging::log_level::error, format, ##__VA_ARGS__)
#define LOG_FATAL(format, ...) LOG_MESSAGE(cfacter::logging::log_level::fatal, format, ##__VA_ARGS__)
#define LOG_IS_ENABLED(level) cfacter::logging::is_log_enabled(g_logger, level)
#define LOG_IS_DEBUG_ENABLED() LOG_IS_ENABLED(cfacter::logging::log_level::debug)
#define LOG_IS_INFO_ENABLED() LOG_IS_ENABLED(cfacter::logging::log_level::info)
#define LOG_IS_WARNING_ENABLED() LOG_IS_ENABLED(cfacter::logging::log_level::warning)
#define LOG_IS_ERROR_ENABLED() LOG_IS_ENABLED(cfacter::logging::log_level::error)
#define LOG_IS_FATAL_ENABLED() LOG_IS_ENABLED(cfacter::logging::log_level::fatal)
...
#endif  // LIB_INC_LOGGING_LOGGING_HPP_H_
