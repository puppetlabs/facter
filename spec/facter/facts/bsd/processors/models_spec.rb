...
describe Facts::Bsd::Processors::Models do
  describe '#call_the_resolver' do
    subject(:fact) { Facts::Bsd::Processors::Models.new }
    ...
    it 'calls Facter::Resolvers::Bsd::Processors' do
      ...
      expect(Facter::Resolvers::Bsd::Processors).to have_received(:resolve).with(:models)
    end
