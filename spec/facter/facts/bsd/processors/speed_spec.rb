...
describe Facts::Bsd::Processors::Speed do
  describe '#call_the_resolver' do
    subject(:fact) { Facts::Bsd::Processors::Speed.new }
    ...
    it 'calls Facter::Resolvers::Macosx::Processors' do
      ...
      expect(Facter::Resolvers::Bsd::Processors).to have_received(:resolve).with(:speed)
    end
