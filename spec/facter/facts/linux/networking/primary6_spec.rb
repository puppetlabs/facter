...
describe Facts::Linux::Networking::Primary do
  describe '#call_the_resolver' do
    ...
    before do
      allow(Facter::Resolvers::NetworkingLinux).to receive(:resolve).with(:primary6_interface).and_return(value)
    end

    it 'calls Facter::Resolvers::NetworkingLinux' do
      fact.call_the_resolver
      expect(Facter::Resolvers::NetworkingLinux).to have_received(:resolve).with(:primary6_interface)
    end
