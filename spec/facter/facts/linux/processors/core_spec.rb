...
describe Facts::Linux::Processors::Cores do
    describe '#call_the_resolver' do
      ...
      before do
        allow(Facter::Resolvers::Linux::ProcessorsLscpu).to \
          receive(:resolve).with(:cores_per_socket).and_return(cores_per_socket)
      end
  
      it 'calls Facter::Resolvers::Linux::ProcessorsLscpu' do
        fact.call_the_resolver
        expect(Facter::Resolvers::Linux::ProcessorsLscpu).to have_received(:resolve).with(:cores_per_socket)
      end
