...
describe Facts::Macosx::Networking::Mac do
  describe '#call_the_resolver' do
    ...
    before do
      allow(Facter::Resolvers::Macosx::Ipaddress).to receive(:resolve).with(:macaddress).and_return(value)
    end

    it 'calls Facter::Resolvers::Macosx::Ipaddress' do
      fact.call_the_resolver
      expect(Facter::Resolvers::Macosx::Ipaddress).to have_received(:resolve).with(:macaddress)
    end
