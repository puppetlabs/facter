...
describe Facts::Openbsd::Dmi::Bios::Version do
  describe '#call_the_resolver' do
    subject(:fact) { Facts::Openbsd::Dmi::Bios::Version.new }
    ...
    it 'calls Facter::Resolvers::Openbsd::DmiBios' do
      ...
      expect(Facter::Resolvers::Openbsd::DmiBios).to have_received(:resolve).with(:bios_version)
    end
