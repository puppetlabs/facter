...
describe Facts::Openbsd::Dmi::Product::Uuid do
  describe '#call_the_resolver' do
    subject(:fact) { Facts::Openbsd::Dmi::Product::Uuid.new }
    ...
    it 'calls Facter::Resolvers::Openbsd::DmiBios' do
      ...
      expect(Facter::Resolvers::Openbsd::DmiBios).to have_received(:resolve).with(:product_uuid)
    end
