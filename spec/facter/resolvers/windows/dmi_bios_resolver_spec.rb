...
describe 'Windows DMIBiosResolver' do
  ...
  after do
    Facter::Resolver::DMIBiosResolver.invalidate_cache
  end
  ...
  context '#resolve' do
    ...
    it 'detects virtual machine manufacturer' do
      expect(Facter::Resolver::DMIBiosResolver.resolve(:manufacturer)).to eql('VMware, Inc.')
    end
    it 'detects virtual machine serial number' do
      expect(Facter::Resolver::DMIBiosResolver.resolve(:serial_number))
  ...
  context '#resolve when WMI query returns nil' do
    ...
    it 'logs debug message and serial_number is nil' do
      ...
      expect(Facter::Resolver::DMIBiosResolver.resolve(:serial_number)).to eql(nil)
    end
    it 'detects manufacturer as nil' do
      expect(Facter::Resolver::DMIBiosResolver.resolve(:manufacturer)).to eql(nil)
    end
  end
