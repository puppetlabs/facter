...
describe 'Windows UptimeResolver' do
  ...
  after do
    Facter::Resolver::UptimeResolver.invalidate_cache
  end
  ...
  context '#resolve system_uptime when system is up for 1 hour' do
    ...
    it 'resolves uptime' do
      expect(Facter::Resolver::UptimeResolver.resolve(:uptime)).to eql('1:0 hours')
    end
    it 'resolves seconds' do
      expect(Facter::Resolver::UptimeResolver.resolve(:seconds)).to eql(3600)
    end
    it 'resolves hours' do
      expect(Facter::Resolver::UptimeResolver.resolve(:hours)).to eql(1)
    end
    it 'resolves days' do
      expect(Facter::Resolver::UptimeResolver.resolve(:days)).to eql(0)
    end
  end
  ...
  context '#resolve system_uptime when system is up for 1 hour and 45 minutes' do
    ...
    it 'resolves uptime' do
      expect(Facter::Resolver::UptimeResolver.resolve(:uptime)).to eql('1:45 hours')
    end
    it 'resolves seconds' do
      expect(Facter::Resolver::UptimeResolver.resolve(:seconds)).to eql(6300)
    end
    it 'resolves hours' do
      expect(Facter::Resolver::UptimeResolver.resolve(:hours)).to eql(1)
    end
  ...
  context '#resolve system_uptime when system is up for 1 hour and 45 minutes and 20 sec' do
    ...
    it 'resolves seconds' do
      expect(Facter::Resolver::UptimeResolver.resolve(:seconds)).to eql(6320)
    end
    it 'resolves hours' do
      expect(Facter::Resolver::UptimeResolver.resolve(:hours)).to eql(1)
    end
  ...
  context '#resolve system_uptime when system is up for 1 day' do
    ...
    it 'resolves uptime' do
      expect(Facter::Resolver::UptimeResolver.resolve(:days)).to eql(1)
    end
    it 'resolves seconds' do
      expect(Facter::Resolver::UptimeResolver.resolve(:seconds)).to eql(86_400)
    end
    it 'resolves hours' do
      expect(Facter::Resolver::UptimeResolver.resolve(:hours)).to eql(24)
    end
    it 'resolvese uptime' do
      expect(Facter::Resolver::UptimeResolver.resolve(:uptime)).to eql('1 day')
    end
  end
  ...
  context '#resolve system_uptime when system is up for more than 1 day' do
    ...
    it 'resolves uptime' do
      expect(Facter::Resolver::UptimeResolver.resolve(:days)).to eql(2)
    end
    it 'resolves seconds' do
      expect(Facter::Resolver::UptimeResolver.resolve(:seconds)).to eql(230_400)
    end
    it 'resolves hours' do
      expect(Facter::Resolver::UptimeResolver.resolve(:hours)).to eql(64)
    end
    it 'resolves uptime' do
      expect(Facter::Resolver::UptimeResolver.resolve(:uptime)).to eql('2 days')
    end
  end
  ...
  context '#resolve system_uptime when local time is behind last bootup time' do
    ...
    it 'logs that is unable to determine system uptime and all facts are nil' do
      ...
      expect(Facter::Resolver::UptimeResolver.resolve(:days)).to eql(nil)
      expect(Facter::Resolver::UptimeResolver.resolve(:uptime)).to eql(nil)
      expect(Facter::Resolver::UptimeResolver.resolve(:seconds)).to eql(nil)
      expect(Facter::Resolver::UptimeResolver.resolve(:hours)).to eql(nil)
    end
  end
